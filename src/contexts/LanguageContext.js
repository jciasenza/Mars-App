...
const translations = {
  es: {
    ...
    about_devs: "Desarrollado en colaboración con el equipo de Google DeepMind.",
  ...
  en: {
    ...
    nav_busquedas: "Saved Searches",
    nav_fotos: "Fav Photos",
    nav_logout: "Logout",
    nav_acerca_de: "About",
    login_kicker: "NASA ROVER EXPLORER",
    ...
    about_devs: "Developed in collaboration with the Google DeepMind team.",
